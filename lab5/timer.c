...
int timer_display_conf(unsigned char conf) {
	...
	//Operation Mode
	if (((conf & BIT(3)) >> 3) == 0 && ((conf & BIT(2)) >> 2) == 0
			&& ((conf & BIT(1)) >> 1) == 0)
		printf("Operating Mode: %s \n", "0 - Interrupt on terminal count");
	if (((conf & BIT(3)) >> 3) == 0 && ((conf & BIT(2)) >> 2) == 0
			&& ((conf & BIT(1)) >> 1) == 1)
		printf("Operating Mode: %s \n", "1 - Hardware retriggerable one-shot");
	if (((conf & BIT(3)) >> 3) == 0 && ((conf & BIT(2)) >> 2) == 1
			&& ((conf & BIT(1)) >> 1) == 0)
		printf("Operating Mode: %s \n", "2 - Rate generator");
	if (((conf & BIT(3)) >> 3) == 1 && ((conf & BIT(2)) >> 2) == 1
			&& ((conf & BIT(1)) >> 1) == 0)
		printf("Operating Mode: %s \n", "2 - Rate generator");
	if (((conf & BIT(3)) >> 3) == 0 && ((conf & BIT(2)) >> 2) == 1
			&& ((conf & BIT(1)) >> 1) == 1)
	...
	if (((conf & BIT(3)) >> 3) == 1 && ((conf & BIT(2)) >> 2) == 1
			&& ((conf & BIT(1)) >> 0) == 1)
		printf("Operating Mode: %s \n", "3 - Square wave mode");
	if (((conf & BIT(3)) >> 3) == 1 && ((conf & BIT(2)) >> 2) == 0
			&& ((conf & BIT(1)) >> 1) == 0)
...
void wait_seconds(unsigned short time) {
